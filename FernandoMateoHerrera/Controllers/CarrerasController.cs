...
namespace FernandoMateoHerrera.Controllers
{
    public class CarrerasController : Controller
    {
        ...
        public CarrerasController(FernandoMateoHerreraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CarreraId,NombreCarrera,Campus,Semestre")] Carrera carrera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarreraId,NombreCarrera,Campus,Semestre")] Carrera carrera)
        {
